...
namespace SuQiong.Application.Extensions
{
    public static class ConsulBuilderExtensions
    {

        public static IApplicationBuilder UseConusl(this IApplicationBuilder app, IHostApplicationLifetime lifetime, ConsulOption consulOption)
        {
